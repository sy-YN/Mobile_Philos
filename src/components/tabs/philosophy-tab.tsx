    ...
    <div className="p-4 space-y-8">
      <section>
        <Dialog>
          ...
          <DialogContent className="sm:max-w-xs bottom-0 top-auto translate-y-0 rounded-b-none rounded-t-lg">
            <DialogHeader>
              ...
              <DialogDescription className="pt-2 text-base leading-relaxed text-left">
